...
export default function LandscapingScreen({ setCurrentScreen, previousScreen }: LandscapingScreenProps) {
    
...
          <Image
            source={{ uri: "https://image2url.com/images/1761643107140-3c2988fe-5e3f-4359-b2ec-05208b5e5e9d.png" }}
            style={styles.image}
            resizeMode="cover"
          />

          <Text style={styles.description}>
            The landscaping course offers skills and knowledge for designing and maintaining both new and established gardens. **Various** content will be covered such as: 
          </Text>
