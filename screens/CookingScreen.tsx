  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Image
          source={require("https://image2url.com/images/1761645016446-ead9f81c-919c-4405-a826-107259665376.webp")}
          style={styles.image}
          resizeMode="cover"
        />

        <Text style={styles.description}>
          This course aims to prepare and cook nutritious family needs, such as: 
        </Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.listItem}>• Nutritional reuirements for a healthy body</Text>
